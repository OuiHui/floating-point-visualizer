...
function parseSpecialInput(str) {
...
function updateVisualization() {
    ...
    const special = parseSpecialInput(inputValue);
...
function isValidBinary(str) {
    // Check if string contains only 0, 1, and at most one decimal point
...
function generateFloat32Visualization(number, binaryInput) {
    ...
    // Create bit labels (31 down to 0)
